...
class AttentionQKV(nn.Module):
    ...
    def flash_attention(self, q, k, v, mask=None):
        # F.scaled_dot_product_attention selects the best backend per device
        # (flash / mem-efficient / math), so no CUDA-specific sdp_kernel
        # context manager is needed and this works on cuda/xpu/cpu.
